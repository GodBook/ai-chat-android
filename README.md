...
- **重塑软件图标（聊天气泡样式 · 液态玻璃风格）**：汲取 Apple VisionOS 空间计算与 iOS 灵动美学灵感，经典贝塞尔聊天气泡外形叠加双层电光青与紫罗兰极光晕染、晶莹液态折射、珍珠微光打字脉冲圆点与超精细环境柔和投影，完美适配 Android 8+ Adaptive Icons（分层 72dp 核心安全区）
- **AI 实时联网搜索（Live Web Search）深度升级**：360 搜索 + Bing 双引擎互备，内置智能口语前缀清洗与低质字典条目净化管线，注入系统强约束 Grounding 事实准则，输入框一键开关，来源卡片支持直接溯源核验
