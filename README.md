...
- **全新重绘品牌图标（苹果设计美学 & 极简扁平化）**：汲取 Apple Minimalist HIG 灵感，极简几何机器人面部搭配电光青微光与深邃星空底色，规范适配 Android 8+ Adaptive Icons（分层 72dp 核心安全区）及各大厂商启动器
- **AI 实时联网搜索（Live Web Search）**：输入栏一键开关、内置高速免配置实时抓取清洗引擎、自动将最新网页摘要注入 AI 对话上下文，回复卡片提供参考来源溯源外链，并在设置页支持配置默认开关
...
- 设置页支持模型接口实时连通性测试：轻量探针测算真实往返 RTT 延迟，精准提示 401 密钥失效、404 模型错误等故障原因
